...
/* код после первого div вырезаем:
<div className="flex flex-col justify-center items-center text-center">
    <h1 className="text-4xl md:text-[40px]">Stay Inspired</h1>
    <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-xl">Join our newsletter 
    and be the first to discover new updates, exclusive offers, and inspiration.</p>
</div>
Также удаляем svg в button и прописываем img
 */