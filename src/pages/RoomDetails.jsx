   ...
   return room && (
        <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
                ...
                transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-3
            ...
            <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
                ...
                grond floor according to availability. You get the comfortable two bedroom
