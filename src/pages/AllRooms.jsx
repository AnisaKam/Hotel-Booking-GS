...
function AllRooms() {
    ...
    return (
        ...
        md:pt-35 px-4 md:px-16 lg:px-24">
            <div>
                <div className="flex flex-col items-start text-left">
                    <h1 className="font-playfair text-4xl md:text-[40px]">Hotel Rooms</h1>
                    <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-174">Take advantage of our limited-time offers and special packeges to enhance your stay
                    ...
                    overflow-hidden transition-all duration-700`}>
                        ...
                        <div className="px-5 pt-5 pb-7">
                            ...
                            {sortOptions.map((options, index) => (
                                <RadioButton key={index} lable={options}/>
                            ))}
                        </div>    
