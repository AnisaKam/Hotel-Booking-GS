...
function MyBookings() {
    ...
    return (
        <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
            <Title title='My Bookings' subTitle='Easile manage your past, current, and 
...
//!!!! БЕЛАЯ СТРАНИЦА БРАУЗЕРА: В этот раз заглючил реакт/браузер при прописывании состояния
//useState. Решение: Все удаляешь, снова прописываешь (если надо несколько раз)
//и параметр - userBookingsDummyData обязательно ОТЩЕЛКИВАЕШЬ (если надо несколько раз). 
// Заработало с шестого раза